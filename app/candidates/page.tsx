        ...
        <Card>
          ...
          <CardContent>
                ...
                <div className='grid grid-cols-2 gap-4 mb-4'>
                  ...
                  <div>
                    ...
                    {getSelectedToTrack && (
                      <div className='mt-2 text-xs text-muted-foreground p-2 bg-muted rounded'>
                        <div className='font-medium'>
                          {getSelectedToTrack.title}
                        </div>
                        <div>{getSelectedToTrack.artist}</div>
                        <div className='mt-1'>
                          BPM: {getSelectedToTrack.bpm} • Key:{' '}
                          {getSelectedToTrack.key} • Energy:{' '}
                          {getSelectedToTrack.energy}
                        </div>
                      </div>
                    )}
                  </div>
              ...
              <div className='mb-4 p-4 bg-muted/50 rounded-lg border'>
                ...
                <div className='grid grid-cols-2 gap-4 text-sm'>
                  <div>
                    ...
                    <div
                      className={cn(
                        'font-mono text-lg',
                        Math.abs(
                          getSelectedFromTrack.bpm - getSelectedToTrack.bpm
                        ) <= 5
                          ? 'text-green-500'
                          : Math.abs(
                              getSelectedFromTrack.bpm - getSelectedToTrack.bpm
                  ...
                  <div>
                    ...
                    >
                      {Math.abs(
                        getSelectedFromTrack.energy - getSelectedToTrack.energy
                      ).toFixed(1)}
                    </div>
                  </div>
                  <div>
            ...
            <Button
              ...
              disabled={loading || !fromTrack || !toTrack || loadingTracks}
            >
                        ...
                        <div className='grid grid-cols-2 gap-4 mb-4'>
                          <div>
                            ...
                            <div className='font-mono'>
                              {formatTime(
                                (candidate as any).from_position ??
